...
export const segaTheme = createTheme({
  palette: {
    mode: "light",
    background: { default: "#F5EFE6", paper: "#FBF6EC" },
    text: { primary: "#1A1410", secondary: "#5A4A3A" },
    primary: { main: "#1E3A8A", contrastText: "#F5EFE6" }, // cobalt
    secondary: { main: "#C73E1D", contrastText: "#F5EFE6" }, // flamboyant red
    error: { main: "#8B2715" },
  ...
  components: {
    ...
    MuiButton: {
      ...
      styleOverrides: {
        root: { borderRadius: 2, paddingInline: 16, height: 44 },
        containedPrimary: {
    ...
    MuiAutocomplete: {
      styleOverrides: { paper: { borderRadius: 2, border: "1.5px solid #C9B89A" } },
    },
    MuiSnackbarContent: {
      styleOverrides: {
        root: { backgroundColor: "#1A1410", color: "#F5EFE6", borderRadius: 2 },
      },
    },
    MuiSlider: {
      styleOverrides: {
